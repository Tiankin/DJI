...
extern "C" {
    ...
    // extern void test_detector_v2(char *datacfg, char *cfgfile, char *weightfile, char *filename, float thresh, float hier_thresh, char *outfile, int fullscreen);
...
int main(int argc, char **argv)
{
    ...
    if(argc < 2){
        ...
        char * cfg_file = "cfg/yolov2.cfg";
        char * weight_file = "yolov2.weights";
        char *filename = "/home/dji/Desktop/test.img";
        char *outfile = 0;
        int fullscreen = 0;
        test_detector_v2("cfg/coco.data", cfg_file, weight_file, filename, .5, .5, outfile, fullscreen);
